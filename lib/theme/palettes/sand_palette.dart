...
/// Sand — accent: #e8d49a (from app.jsx ACCENTS)
const sandPalette = AppPalette(
  background: Color(0xFF0A0D0B),
  surface: Color(0xFF101512),
  surfaceMuted: Color(0xFF141A17),
  border: Color(0x14B4DCC8),
  borderHighlight: Color(0x2EE8D49A),
  textPrimary: Color(0xFFE2E6E2),
  textSecondary: Color(0xFF8A918A),
  textMuted: Color(0xFF525A52),
  accent: Color(0xFFE8D49A),
  accentMuted: Color(0x8CE8D49A),
  accentText: Color(0xFF181406),
  accentGhost: Color(0x24E8D49A),
  accentGlow: Color(0x52E8D49A),
  bubbleSent: Color(0x14E8D49A),
