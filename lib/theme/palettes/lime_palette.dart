...
/// Lime — accent: #c8f08a (from app.jsx ACCENTS)
const limePalette = AppPalette(
  background: Color(0xFF0A0D0B),
  surface: Color(0xFF101512),
  surfaceMuted: Color(0xFF141A17),
  border: Color(0x14B4DCC8),
  borderHighlight: Color(0x2EC8F08A),
  textPrimary: Color(0xFFE2E6E2),
  textSecondary: Color(0xFF8A918A),
  textMuted: Color(0xFF525A52),
  accent: Color(0xFFC8F08A),
  accentMuted: Color(0x8CC8F08A),
  accentText: Color(0xFF0E1806),
  accentGhost: Color(0x24C8F08A),
  accentGlow: Color(0x52C8F08A),
  bubbleSent: Color(0x14C8F08A),
